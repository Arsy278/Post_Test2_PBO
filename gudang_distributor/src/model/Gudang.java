...
public final class Gudang implements crud {
    ...
    public Gudang() {
        ...
        daftarProduk.add(produkInstance.new makananRingan("Jelly Piala Mini", 55_000, 348));
        daftarProduk.add(produkInstance.new makananRingan("Caramell Ball", 115_000, 263));
        daftarProduk.add(produkInstance.new minuman("Happy Es teller", 40_000, 238));
    }
